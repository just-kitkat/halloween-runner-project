...
def display_startingmsg():
    print(
        "Welcome to Halloween Runner! Are you ready for an adventure? Let's go!"
    )
    time.sleep(2)
    ye = True
    while ye:
...
def action_3():
    print(
        "You hear the faint echo of distant whispers, the creak of ancient floorboards, and the occasional soft thud as if something unseen is moving nearby. Despite the unsettling noises, nothing happens, leaving you in a tense, nerve-wracking stillness that makes every shadow seem alive."
    )


def action_1():
    print(
        'As you move forward through the dark castle, a shadow suddenly darts past you, too quick to see clearly. Heart pounding, you freeze, waiting for something to happen. But nothing does. The silence presses in, and the tension mounts with each step, knowing something is lurking just out of sight.'
    )


def action_2():
    print(
        'Turning around quickly, you peer into the darkness, but there’s nothing there. Just an empty, silent corridor. The hairs on the back of your neck stand up as the oppressive silence presses in, leaving you with the unsettling feeling that you’re not alone.'
    )


def blackout_msg():
    print(
        'As you turn around, something hard strikes the back of your head. Pain explodes through your skull, and your vision blurs. The last thing you see before everything goes black is the cold, dark corridor closing in around you. \n...\n'
    )
    time.sleep(6)
